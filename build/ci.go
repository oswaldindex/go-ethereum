...
import (
	...
	"github.com/oswaldindex/arbi-geth/crypto/signify"
	"github.com/oswaldindex/arbi-geth/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/oswaldindex/arbi-geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/oswaldindex/arbi-geth/internal/version.gitDate="+env.Date)
	}
